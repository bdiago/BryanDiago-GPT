...
def main():
    ...
    if args.interface == "cli":
        ...
        st.write("An AI thats trained to be like {}! Ask {}-GPT anything about their resume, work experince and personal life.".format(args.character_name, args.character_name))
